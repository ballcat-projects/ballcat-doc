import{_ as n,o as s,c as a,e}from"./app-c2dc8116.js";const p={},i=e(`<h1 id="前端部署" tabindex="-1"><a class="header-anchor" href="#前端部署" aria-hidden="true">#</a> 前端部署</h1><h2 id="代码构建" tabindex="-1"><a class="header-anchor" href="#代码构建" aria-hidden="true">#</a> 代码构建</h2><p>只需要在前端项目根路径执行如下命令之一，即可完成构建。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">yarn</span> build
or
